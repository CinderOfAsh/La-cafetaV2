        ...
        <>
          <div className="mb-4 flex items-center gap-3">
            <div className="relative flex-1 max-w-xs">
              ...
              <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar por nombre, email..." className="w-full rounded-lg border border-dark/10 pl-10 pr-3 py-2 text-sm text-dark placeholder-light-grey" />
            </div>
